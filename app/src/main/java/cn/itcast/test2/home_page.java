...
public class home_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String time=pref.getString("time","第一次登录");
        SharedPreferences pref2=getSharedPreferences("cishu",MODE_PRIVATE);
        //String time=pref.getString("time","第一次登录");
        int cishu2=pref2.getInt("cishu",0);
        time2.setText("上次登录时间："+time);
        cishu.setText("登录次数："+cishu2);
        //获取当前时间
        date = new Time();
        date.setToNow();
        month=date.month;
        ...
        mAdapter.setOnItemClickListener(new CostListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                //Intent intent = new Intent(home_page.this, Account.class);
                Intent intent = new Intent(home_page.this, Select.class);
